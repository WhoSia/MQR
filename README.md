...
- `language/real/README.md` — Real-Language v0.3–v0.15, including proof, transfer, composition, substitution, contact-rank, open-frontier, attention-allocation and obligation-constitution lanes
...
- `experiments/mqr-4.48/` — current live adversarial court; MQR-4.48 audits the ontology used to individuate the defeat routes that serve as the coverage basis for separator adequacy

Real-Language v0.3 remains the transport-compatible historical lane; v0.4 is the proof-boundary lane; v0.5 is the executable authority-transfer lane; v0.6 adds compositional transfer; v0.7 adds world-contact substitution; v0.8 adds frontier-relative contact-rank analysis; v0.9 adds open rival-frontier governance; v0.10 adds contract-relative finite-attention allocation; v0.11 adds exploration-obligation constitution audit; v0.12 adds versioned burden-ontology transport; v0.13 adds contestable translation-authority audit; v0.14 adds translation-challenge constitution and separator-family authority audit; v0.15 adds defeat-route ontology constitution and versioned content-sensitive coverage transport. MQR-4.42 rejects frontier-completeness certification. MQR-4.43 rejects a free universal optimizer over unconceived rivals. MQR-4.44 rejects the obligation set as self-justifying; MQR-4.45 rejects burden-atom persistence across ontology revision; MQR-4.46 rejects declared mapping relations, adjudicator plurality, standards and meta-validation as automatic correspondence oracles; MQR-4.47 rejects world-facing status, raw probe multiplicity and finite challenge stability as automatic separator-selection authority or challenge-space closure; MQR-4.48 rejects route labels, route counts and equal nominal coverage fractions as automatic defeat-route identity or coverage equivalence. Formalization remains route-relative and optional. Scalar projection remains OFF and truth-distance semantics remain UNIDENTIFIED.
