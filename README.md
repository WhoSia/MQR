...
- `language/real/README.md` — Real-Language v0.3–v0.14, including proof, transfer, composition, substitution, contact-rank, open-frontier, attention-allocation and obligation-constitution lanes
